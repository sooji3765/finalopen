...
<body>
    ...
    <header class="masthead bg-primary text-white text-center">
      	<div class="container">
      		<input type="button" class="btn btn-info" value="새로운 냉장고 사용" onclick="javascript:location.href='/ref/selectRef.do';"/>
      		
      		<input type="button" class="btn btn-default" value="기존 냉장고 사용" onclick="javascript:location.href='/ref/searchRef.do';"/>
